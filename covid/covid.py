...
from synergy.core.utils.chat_formatting import humanize_number
...
class Covid(commands.Cog):
    ...
    async def synergy_get_data_for_user(self, *, user_id: int):
        # Does not store end user data
        return {}

    async def synergy_delete_data_for_user(self, *, requester, user_id: int) -> None:
        # Does not store end user data
        pass
    ...
    async def on_synergy_api_tokens_update(self, service_name, api_tokens):
